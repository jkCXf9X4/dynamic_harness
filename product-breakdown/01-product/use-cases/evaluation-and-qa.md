...
related:
  ...
  - ../../05-operation/guides/prompt-optimization.md
  - ../../05-operation/guides/benchmark-alternatives.md
---
...
`../../05-operation/guides/prompt-optimization.md` §6 for applying the winning prompt).
