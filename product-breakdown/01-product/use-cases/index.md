...
concepts (`../../02-architecture/concepts/`) and the concrete runtime/tools in `src/`. Use-cases
...
4. **Self-healing** — a blunt failure resumes; a poisoned context spawns a fresh
   worker; a structural failure escalates (`../../02-architecture/concepts/self-healing.md`).
