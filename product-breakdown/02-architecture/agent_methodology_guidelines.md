...
Based on [VISION.md](../00-intent/VISION.md) and the agent system prompt. All principles derive from ISO/IEC 15288 systems engineering practices.
...
See [references/guidelines.md](../../docs/references/guidelines.md) → "The Kill → Inspect → Retry
