...
summary: >
  ...
  together. Parent-mediated relaying (option A) is rejected — see the decision log (../../decision-log.md, DL-*) and AD-001 (../decisions/AD-001.md).
---
...
- Self-heal layers documented — `../concepts/self-healing.md`
...
- [x] Read `../concepts/delegation-model.md` + `../concepts/self-healing.md` end-to-end
