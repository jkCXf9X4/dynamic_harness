...
guarantee — most directly `../01-product/use-cases/repository-analysis.md` §Verification, and the
...
progressively load[ing] more detail as needed" (`../02-architecture/concepts/artifact-system.md:22-61`).
...
parent resolves a child's output via its artifact ID (`../02-architecture/concepts/artifact-system.md:16`,
...
**Concept/docs:** `../02-architecture/examples/delegation_descriptions.md`, `../02-architecture/examples/task_framing.md`,
`../02-architecture/concepts/artifact-system.md` all instruct agents to "write to `/tmp/security_findings.json`
...
(`../02-architecture/examples/*.md`, `../../docs/api/task.md`, `../02-architecture/concepts/artifact-system.md`) no longer
...
**Breaks:** `../01-product/use-cases/embedding-and-integration.md` Scenario B ("the LLM can spawn it via
...
- `../05-operation/guides/prompt-optimization.md:149-152` says the prompt loads "at agent.py:26";
...
Failure triage (use-cases `../01-product/use-cases/evaluation-and-qa.md` Scenario C) requires reading
