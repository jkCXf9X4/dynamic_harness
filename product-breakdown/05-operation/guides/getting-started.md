...
more — is documented in the [Configuration Reference](../../../docs/api/config.md), with defaults
...
1. Read the [agent methodology guidelines](../../02-architecture/agent_methodology_guidelines.md) to understand how agents work
...
5. Read the [architecture overview](../../00-intent/VISION.md) for design philosophy
