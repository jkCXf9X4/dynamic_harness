...
| "Delegate when it pays; right-size ceremony" | DL-13 (golden delegation rule) | `02-architecture/methodology/README.md`, `docs/references/guidelines.md`, `docs/references/tool_motivations.md` |
| "Child autonomy safe via intent" | DL-15 (mission-command briefs) | `docs/references/mission_command_rationale.md`, `02-architecture/concepts/delegation-model/README.md`, `03-implementation/` policies (BriefPolicy) |
